...
function getTokens(customFoundation) {
  ...
  return {
    ...
    backgroundTableShadowLeft:
      "linear-gradient(to left, transparent, " + convertHexToRgba(theme.palette.ink.lighter, 23) + ")",
    backgroundTableShadowRight:
      "linear-gradient(to right, transparent, " + convertHexToRgba(theme.palette.ink.lighter, 23) + ")",
    ...
    backgroundModalSectionSuppressed: theme.palette.cloud.light,
    backgroundModalSection: theme.palette.white.normal,
    backgroundModalHeaderSuppressed: theme.palette.cloud.light,
    backgroundModalHeader: theme.palette.white.normal,
    backgroundModalFooter: theme.palette.white.normal,
    // category:Font size
    ...
    fontSizeModalMobileHeader: "18px",
    ...
    heightModalCloseContainer: theme.base.size2xl,
    ...
    borderColorModalSection: theme.palette.cloud.normal,
    borderColorModalHeader: theme.palette.cloud.normal,
    ...
    borderStyleModalSection: "solid",
    borderWidthModalSection: "1px",
    borderStyleModalHeader: "solid",
    borderWidthModalHeader: "1px",
    // category:Opacity
    // description:
    ...
    paddingModalBody: theme.base.size2xl,
    paddingModalSection: {
      default: theme.base.spaceLg + " " + theme.base.spaceMd,
      largeMobile: theme.base.space2xl,
    },
    paddingModalMobileHeader: "0 0 0 " + theme.base.spaceLg,
    paddingModalHeaderSuppressedWithIllustration: {
      default: theme.base.spaceXl + " " + theme.base.spaceMd + " " + theme.base.spaceLg + " " + theme.base.spaceMd,
      largeMobile: theme.base.spaceXl + " " + theme.base.space2xl + " " + theme.base.space2xl,
    },
    paddingModalHeaderWithIllustration: {
      default: theme.base.spaceXl + " " + theme.base.spaceMd + " 0 " + theme.base.spaceMd,
      largeMobile: theme.base.spaceXl + " " + theme.base.space2xl + " 0 " + theme.base.space2xl,
    },
    paddingModalHeaderSuppressed: {
      default: theme.base.spaceLg + " " + theme.base.spaceMd,
      largeMobile: theme.base.space2xl,
    },
    paddingModalHeader: {
      default: theme.base.spaceLg + " " + theme.base.spaceMd + " 0 " + theme.base.spaceMd,
      largeMobile: theme.base.space2xl + " " + theme.base.space2xl + " 0 " + theme.base.space2xl,
    },
    paddingModalFooter: "0 " + theme.base.spaceMd + " " + theme.base.spaceMd,
    paddingModalFooterChild: "0 " + theme.base.spaceMd + " 0 0",
