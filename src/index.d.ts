// Type definitions for @kiwicom/orbit-design-tokens
// Project: http://github.com/kiwicom/orbit-design-tokens

declare module '@kiwicom/orbit-design-tokens';

import { DeepPartial } from 'ts-esentials';
...
type CustomFoundation = DeepPartial<Foundation>;

export type FromPlainObject = (themePaletteColors: ThemePaletteColors) => Tokens;
export type GetTokens = (customFoundation?: CustomFoundation) => Tokens;

export declare let getTokens: GetTokens;
export declare let fromPlainObject: FromPlainObject;
export declare let defaultTokens: Tokens;
